...
{
    /// <inheritdoc />
    public partial class AddEmployeesAndTasks : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeTasks_Animals_AnimalId",
                        column: x => x.AnimalId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeTasks_AnimalId",
                table: "EmployeeTasks",
                column: "AnimalId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostPriceBDT = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    SellPriceBDT = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
